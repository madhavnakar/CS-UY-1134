'''
The Queue ADT
- Mathematical model: FIFO

Operations:
- Queue(): creates a new empty Queue
- Q.is_empty: returns True if Q is empty
- len(Q): returns the number of elements currently in Q
- Q.enque(elem): adds elem to end of the Q
- Q.deque(): removes and returns the front element in Q or
raises an exception if Q is empty 
- Q.front(): returns the element in the front of Q without 
removiing it. Or raises an exception if Q is empty.
'''
